...
import { View, Text, Image, StatusBar, ScrollView, Dimensions, StyleSheet, TextInput, TouchableOpacity, ActivityIndicator } from "react-native";
    ...
    <View style={styles.container}>
        ...
        <ScrollView>
            ...
            <View style={styles.formRow}>
                <TextInput 
                    value={props.tags} 
                    placeholder={"Tags (separted by commas)"} 
                    style={styles.input}
                    placeholderTextColor={"#888"}
                    autoCapitalize={"none"}
